  ...
  <div class="w3-light-grey w3-container w3-padding-32" style="margin-top:75px;padding-right:58px">
    ...
    <script type="text/javascript">
        ...
        function validation(){
            ...
            var mailregex = /^[A-Za-z0-9]+@[A-Za-z0-9]+.com$/;
            ...
            if(b.length>8)
            {
                alert("Name should not be long.Should be less than 8 characters");
                return false;
            }
            if(b == ""||b==null)
            {
            ...
            if (!mailregex.test(d)) 
            {
                alert("Email should be in the format example@company.com");
                return false;
             }
