...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
    ...
    <div class="w3-container" id="contact" style="margin-top:75px">
        <h1 class="w3-xxxlarge w3-text-black"><b>Instructor login.</b></h1>
        <hr style="width:50px;border:5px solid w3-text-black" class="w3-round">
        <p>Welcome to Course Gradebook !</p>
        <form action="Instructor_login.php" method="post" target="_blank">
...
if(isset($_POST['submit'])) {
    ...
    $sql = "SELECT I_id FROM instructor WHERE Email = '$myusername' and Password = '$mypassword'"; 
    ...
    if ($result=mysqli_query($conn,$sql))
    {
        ...
        try{
           ...
           ?>
                    ...
                    <script>window.location.href = "ProfessorPage.php";</script>
